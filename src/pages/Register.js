// // tokenization-frontend/src/pages/Register.js
...
// tokenization-frontend/src/pages/Register.js
// COMPLETE VERSION WITH EMAIL VERIFICATION SUCCESS SCREEN
...
const RegisterPage = () => {
        ...
        <div className="relative max-w-2xl mx-auto">
          <div className="bg-white bg-opacity-10 backdrop-blur-lg border border-white border-opacity-20 rounded-2xl shadow-2xl p-8">
            <div className="text-center">
              ...
              <p className="text-blue-300 font-semibold text-xl mb-6">
                {formData.email}
              </p>
              
              <div className="bg-blue-500 bg-opacity-20 border border-blue-500 border-opacity-50 rounded-lg p-6 mb-6">
                ...
                <ol className="text-left text-gray-300 space-y-2 text-sm max-w-md mx-auto">
                  <li className="flex items-start">
                    <span className="font-bold text-blue-300 mr-2">1.</span>
                    <span>Open your email inbox and look for our verification email</span>
                  </li>
                  <li className="flex items-start">
                    <span className="font-bold text-blue-300 mr-2">2.</span>
                    <span>Click the verification link in the email</span>
                  </li>
                  <li className="flex items-start">
                    <span className="font-bold text-blue-300 mr-2">3.</span>
  ...
  // REGISTRATION FORM (Steps 1, 2, 3) - UNCHANGED
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="absolute inset-0 bg-black opacity-20"></div>
      ...
      <div className="relative max-w-2xl mx-auto">
        ...
        <div className="bg-white bg-opacity-10 backdrop-blur-lg border border-white border-opacity-20 rounded-2xl shadow-2xl p-8">
          ...
          {/* STEP 2 - Personal Info - Keep your existing code */}
          {step === 2 && (
            <div className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
          ...
          {/* STEP 3 - Additional Info - Keep your existing code */}
          {step === 3 && (
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-gray-200 mb-2">Phone Number</label>
